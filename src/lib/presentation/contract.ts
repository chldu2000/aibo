...
export type Action = { id: 'refresh' | 'inspect' | 'open-diff' | 'back' | 'next' | 'previous'; label: string; intent: 'refresh' | 'inspect' | 'navigate'; enabled: boolean };
...
export type Snapshot = {
  schema: typeof SEMANTIC_SCHEMA | 'aibo.semantic-view/experimental-v1';
  context: Context;
