...
function semanticTokens(colors: ShadcnColorTokens): Record<`--${string}`, string> {
  return {
    ...
    '--ring': colors.ring,
    '--radius': '0.5rem',
    '--aibo-radius': 'var(--radius)',
    '--aibo-radius-sm': 'calc(var(--radius) - 4px)',
    '--aibo-elevation-1': '0 1px 3px 0 rgb(0 0 0 / 10%), 0 1px 2px -1px rgb(0 0 0 / 10%)',
    '--aibo-elevation-2': '0 10px 15px -3px rgb(0 0 0 / 10%), 0 4px 6px -4px rgb(0 0 0 / 10%)',
  };
}
