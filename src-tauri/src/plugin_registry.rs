...
mod tests {
    ...
    async fn bundled_codex_release_is_installed_enabled_and_idempotent() {
        ...
        assert!(installed.iter().all(|plugin| plugin.plugin_version == "2.0.1"));
