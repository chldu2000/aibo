...
const provider=sessionProvider({engine,pluginId:manifest.pluginId,actions:{"dev.aibo.codex.session.snapshot":"ext.dev.aibo.codex.snapshot","dev.aibo.codex.session.fork":"ext.dev.aibo.codex.fork","dev.aibo.codex.goal.manage": "ext.dev.aibo.codex.goal", "dev.aibo.codex.model.select": "ext.dev.aibo.codex.model", "dev.aibo.codex.model.reasoning": "ext.dev.aibo.codex.reasoning", "dev.aibo.codex.skill.list": "ext.dev.aibo.codex.skills", "dev.aibo.codex.approval.respond": "ext.dev.aibo.codex.approval", "dev.aibo.codex.user-input.respond": "ext.dev.aibo.codex.user-input"}});
