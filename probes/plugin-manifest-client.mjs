...
const view = structuredClone(baseView); view.contributions[0].semanticType = 'inspector';
...
window.manifestProbe = { calls, async render(kit) {
  ...
  component = mount(PluginManagerPanel, { target: document.getElementById('probe'), props: {
    installations: [
      { id:'view',pluginId:view.pluginId,pluginVersion:'1.0.0',installed:true,enabled:false,runnable:false,dependencies:[],manifest:view,activationIssues:['插件已登记；此版本尚未支持 inspector 语义类型。'] },
